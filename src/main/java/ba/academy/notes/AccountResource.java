...
import ba.academy.notes.services.AccountService;
...
public class AccountResource {
    ...
    @Produces(value = MediaType.APPLICATION_JSON)
    public Response create(AccountDto dtoAtribute, @Context UriInfo uriInfo)
    {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces(value = MediaType.APPLICATION_JSON)
    public Response updateDiary(AccountDto dtoAtribute, @PathParam("id") int id, @Context UriInfo uriInfo) {
